<div class="panel panel-theme rounded shadow">
    ...
    <div class="panel-body no-padding rounded">
        <ul class="list-group no-margin">
            <li style="  word-wrap: break-word;" class="list-group-item"><i class="fa fa-envelope mr-5" style="float:left; margin-top:1px "></i> <span style="margin-left:5px">{{$email}}</span></li>
